...
object HomeSource {
    ...
    val Department: List<HomeDP> = listOf(
        ...
        HomeDP("Chemical","https://hbtu.ac.in/chemical-engineering-2/"),HomeDP("IT","https://hbtu.ac.in/computer-science-engineering-2/"),
    ...
    val Syllabus: List<HomeDP> = listOf(
        ...
        HomeDP("Chemical","1c.pdf"),HomeDP("IT","2.pdf"),
